  ...
  ><div
  className="flex flex-col items-start justify-start mb-[14px] md:ml-[0] ml-[108px] md:w-[100%] w-[auto]"
  ...
  >Blog Posts</Text></div></div></div></div><div
  ...
  ><List
    className="md:flex-1 flex-col gap-[32px] grid md:w-[100%] w-[67%]"
    
    orientation="vertical"
    
  ><div
  className="flex flex-col items-start justify-start my-[0] w-[100%]"
  ...
  ><div className="common-pointer bg-transparent cursor-pointer font-medium font-worksans leading-[normal] text-[16px] text-indigo_900 text-left">Read More</div></Button></div></List><div
...
variant="srcFillIndigo900"
  ...
  className="flex flex-row font-worksans sm:gap-[40px] items-center justify-between md:ml-[0] ml-[187px] mt-[32px] md:px-[20px] md:w-[100%] w-[49%]"
  
  
  ><div
  className="flex flex-row gap-[10px] items-center justify-center w-[auto]"
  ...
  >Previous Page</Text></div><Text
    className="font-normal not-italic text-indigo_900 text-right w-[auto]"
     variant="body2"

    
  ><span  className="text-indigo_900 text-[16px] font-worksans" >1 - </span><span  className="text-blue_500 text-[16px] font-worksans" >2 </span><span  className="text-indigo_900 text-[16px] font-worksans" >-</span><span  className="text-blue_500 text-[16px] font-worksans" > 3 </span><span  className="text-indigo_900 text-[16px] font-worksans" >-</span><span  className="text-blue_500 text-[16px] font-worksans" > 4 </span><span  className="text-indigo_900 text-[16px] font-worksans" >-</span><span  className="text-blue_500 text-[16px] font-worksans" > 5</span></Text><div
  className="flex flex-row gap-[10px] items-center justify-center w-[auto]"
  ...
  className="bg-indigo_900 flex font-worksans items-center justify-center mt-[46px] md:px-[20px] w-[100%]"
