    ...
    import {Text,Img,Button,Line,PagerIndicator,Slider} from 'components'
...
variant="FillIndigo900"
  >View Profile</Button></div></div></div></div><div
  ...
  /></div></div></div><div
  className="bg-gray_50 flex font-worksans items-center justify-end p-[64px] sm:px-[20px] md:px-[40px] w-[100%]"
